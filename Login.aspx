<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="ComputerIndy.Login" %>
...
<head>
    ...
    <title>Login สมาชิกคอมพิวเตอร์อินดี้</title>
    <!--
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                                ...
                                <div class="input-group mt-3">
                                    ...
                                    <p><center><td>
                                        <asp:Button ID="Button1" runat="server" Text="เข้าสู่ระบบ" CssClass="btn btn-inline-light btn-lg px-5" />

                                               </td></center></div>
                        <br />
                        <br />
                        <br />
                        <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ยังไม่มีบัญชียังงั้นหรอ ? สมัครตรงนี้เลย <a href="register.aspx">Click me </a></center></div>
                    </div>
                <div> <center><h1><a href="Index.aspx">&nbsp;</a></h1>
                    <h1><a href="Index.aspx">
                        <asp:Button ID="Button2" runat="server" Text="กลับไปหน้าหลัก" />
                        </a></h1></center></div>
                </div>
            </div>
        </div>
